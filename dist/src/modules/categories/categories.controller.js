...
let CategoriesController = class CategoriesController {
    ...
    async getMasters(id, page, limit, cursor) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get masters in category (cursor-paginated)' }),
    ...
    __metadata("design:returntype", Promise)
], CategoriesController.prototype, "getMasters", null);
__decorate([
    (0, common_1.Post)(),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)('ADMIN'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Toggle category active status (admin only)' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)('ADMIN'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get categories statistics (admin only)' }),
    __metadata("design:type", Function),
