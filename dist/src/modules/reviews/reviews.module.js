...
exports.ReviewsModule = ReviewsModule = __decorate([
    (0, common_1.Module)({
        imports: [prisma_module_1.PrismaModule, redis_module_1.RedisModule, notifications_module_1.NotificationsModule],
        controllers: [reviews_controller_1.ReviewsController],
        providers: [reviews_service_1.ReviewsService, reviews_action_service_1.ReviewsActionService, reviews_query_service_1.ReviewsQueryService],
