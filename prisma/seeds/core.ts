...
export async function seedCategories(client: PrismaClient): Promise<void> {
  const categories: {
    ...
    {
      slug: 'agro-servicii',
      name: 'Servicii agricole',
      icon: '🚜',
      iconKey: 'Tractor',
      sortOrder: 200,
      translations: {
        ro: { name: 'Servicii agricole' },
        ru: { name: 'Сельхозуслуги' },
        en: { name: 'Agricultural services' },
      },
    },
    {
      slug: 'fantani-puturi',
      name: 'Fântâni și fose septice',
      icon: '💧',
      iconKey: 'Waves',
      sortOrder: 210,
      translations: {
        ro: { name: 'Fântâni și fose septice' },
        ru: { name: 'Скважины и септики' },
        en: { name: 'Wells & septics' },
      },
    },
    {
      slug: 'ghid-turism',
      name: 'Ghizi turistici',
      icon: '🗺️',
      iconKey: 'Compass',
      sortOrder: 220,
      translations: {
        ro: { name: 'Ghizi turistici' },
        ru: { name: 'Гиды и экскурсии' },
        en: { name: 'Tour guides' },
      },
    },
    {
      ...
      sortOrder: 230,
      translations: {
        ro: { name: 'Dezvoltare IT' },
        ru: { name: 'IT-разработка' },
        en: { name: 'IT development' },
      },
    },
    {
      slug: 'smm-marketing',
      ...
      sortOrder: 240,
      translations: {
        ro: { name: 'SMM și publicitate' },
        ru: { name: 'SMM и реклама' },
        en: { name: 'SMM & marketing' },
      },
    },
    {
      slug: 'design-grafic',
      ...
      sortOrder: 250,
      translations: {
        ro: { name: 'Design grafic' },
        ru: { name: 'Графический дизайн' },
        en: { name: 'Graphic design' },
      },
    },
    {
      slug: 'videomontaj-animatie',
      name: 'Montaj video și animație',
      icon: '🎬',
      iconKey: 'Clapperboard',
      sortOrder: 260,
      translations: {
        ro: { name: 'Montaj video și animație' },
        ru: { name: 'Видеомонтаж и анимация' },
        en: { name: 'Video editing & animation' },
      },
    },
    {
      slug: '3d-laser',
      name: 'Imprimare 3D și tăiere laser',
      icon: '🖨️',
      iconKey: 'Box',
      sortOrder: 270,
      translations: {
        ro: { name: 'Imprimare 3D și tăiere laser' },
        ru: { name: '3D-печать и лазерная резка' },
        en: { name: '3D printing & laser cutting' },
      },
    },
    {
      slug: 'panouri-solare',
      ...
      sortOrder: 280,
      translations: {
        ro: { name: 'Panouri solare' },
        ru: { name: 'Солнечные панели' },
        en: { name: 'Solar panels' },
      },
    },
    {
      slug: 'antrenori-fitness',
      name: 'Antrenori și fitness',
      icon: '🏋️',
      iconKey: 'Dumbbell',
      sortOrder: 290,
      translations: {
        ro: { name: 'Antrenori și fitness' },
        ru: { name: 'Тренеры и фитнес' },
        en: { name: 'Personal trainers & fitness' },
      },
    },
    {
      slug: 'yoga-pilates',
      name: 'Yoga, pilates și dans',
      icon: '🧘',
      iconKey: 'Flower2',
      sortOrder: 300,
      translations: {
        ro: { name: 'Yoga, pilates și dans' },
        ru: { name: 'Йога, пилатес и танцы' },
        en: { name: 'Yoga, pilates & dance' },
      },
    },
    {
      slug: 'psihologi-coaching',
      name: 'Psihologi și coaching',
      icon: '🧠',
      iconKey: 'Brain',
      sortOrder: 310,
      translations: {
        ro: { name: 'Psihologi și coaching' },
        ru: { name: 'Психологи и коучи' },
        en: { name: 'Psychologists & coaches' },
      },
    },
    {
      slug: 'fizioterapie',
      name: 'Fizioterapie la domiciliu',
      icon: '🩺',
      iconKey: 'Stethoscope',
      sortOrder: 320,
      translations: {
        ro: { name: 'Fizioterapie la domiciliu' },
        ru: { name: 'Физиотерапия на дому' },
        en: { name: 'Physiotherapy at home' },
      },
    },
    {
      slug: 'ingrijire-varstnici',
      name: 'Îngrijire vârstnici',
      icon: '👵',
      iconKey: 'HandHeart',
      sortOrder: 330,
      translations: {
        ro: { name: 'Îngrijire vârstnici' },
        ru: { name: 'Уход за пожилыми' },
        en: { name: 'Senior care' },
      },
    },
    {
      slug: 'dj-muzicieni',
      name: 'DJ și muzicieni',
      icon: '🎧',
      iconKey: 'Music',
      sortOrder: 340,
      translations: {
        ro: { name: 'DJ și muzicieni' },
        ru: { name: 'DJ и музыканты' },
        en: { name: 'DJs & musicians' },
      },
    },
    {
      slug: 'animatori-copii',
      name: 'Animatori pentru copii',
      icon: '🎉',
      iconKey: 'PartyPopper',
      sortOrder: 350,
      translations: {
        ro: { name: 'Animatori pentru copii' },
        ru: { name: 'Аниматоры для детей' },
        en: { name: 'Children entertainers' },
      },
    },
    {
      slug: 'sunet-evenimente',
      name: 'Sunet pentru evenimente',
      icon: '🎤',
      iconKey: 'Mic2',
      sortOrder: 360,
      translations: {
        ro: { name: 'Sunet pentru evenimente' },
        ru: { name: 'Звукорежиссёры' },
        en: { name: 'Sound engineers' },
      },
    },
    {
      slug: 'tatuaje-piercing',
      name: 'Tatuaje și piercing',
      icon: '✒️',
      iconKey: 'Syringe',
      sortOrder: 370,
      translations: {
        ro: { name: 'Tatuaje și piercing' },
        ru: { name: 'Тату и пирсинг' },
        en: { name: 'Tattoo & piercing' },
      },
    },
    {
      slug: 'tamplarie',
    ...
    },
    {
      ...
      sortOrder: 400,
      translations: {
        ro: { name: 'Șofer personal' },
        ru: { name: 'Личный водитель' },
        en: { name: 'Personal driver' },
      },
    },
  ];
