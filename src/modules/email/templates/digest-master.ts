...
const T = {
  ro: {
    subject: 'MoldMasters: Digest pentru meșteri — cereri și actualizări',
  ...
  ru: {
    subject: 'MoldMasters: Дайджест для мастеров — заявки и обновления',
    html: (ctx: TemplateContext) => `
  ...
  en: {
    subject: 'MoldMasters: Digest for masters — requests and updates',
    html: (ctx: TemplateContext) => `
