export const ropaLabelKeys = [
  'title', 'subtitle', 'generated', 'controller', 'address', 'dpo', 'dpoContact',
  'colActivity', 'colSubjects', 'colCategories', 'colPurpose',
  'colLegalBasis', 'colRecipients', 'colRetention', 'colTransfers', 'colMeasures',
  'act_registration', 'sub_registration', 'cat_registration', 'pur_registration',
  'bas_registration', 'rec_registration', 'ret_registration', 'tra_registration', 'mea_registration',
  'act_masterProfile', 'sub_masterProfile', 'cat_masterProfile', 'pur_masterProfile',
  'bas_masterProfile', 'rec_masterProfile', 'ret_masterProfile', 'tra_masterProfile', 'mea_masterProfile',
  'act_verification', 'sub_verification', 'cat_verification', 'pur_verification',
  'bas_verification', 'rec_verification', 'ret_verification', 'tra_verification', 'mea_verification',
  'act_leads', 'sub_leads', 'cat_leads', 'pur_leads',
  'bas_leads', 'rec_leads', 'ret_leads', 'tra_leads', 'mea_leads',
  'act_bookings', 'sub_bookings', 'cat_bookings', 'pur_bookings',
  'bas_bookings', 'rec_bookings', 'ret_bookings', 'tra_bookings', 'mea_bookings',
  'act_reviews', 'sub_reviews', 'cat_reviews', 'pur_reviews',
  'bas_reviews', 'rec_reviews', 'ret_reviews', 'tra_reviews', 'mea_reviews',
  'act_payments', 'sub_payments', 'cat_payments', 'pur_payments',
  'bas_payments', 'rec_payments', 'ret_payments', 'tra_payments', 'mea_payments',
  'act_loginHistory', 'sub_loginHistory', 'cat_loginHistory', 'pur_loginHistory',
  'bas_loginHistory', 'rec_loginHistory', 'ret_loginHistory', 'tra_loginHistory', 'mea_loginHistory',
  'act_analytics', 'sub_analytics', 'cat_analytics', 'pur_analytics',
  'bas_analytics', 'rec_analytics', 'ret_analytics', 'tra_analytics', 'mea_analytics',
  'act_consent', 'sub_consent', 'cat_consent', 'pur_consent',
  'bas_consent', 'rec_consent', 'ret_consent', 'tra_consent', 'mea_consent',
  'act_notifications', 'sub_notifications', 'cat_notifications', 'pur_notifications',
  'bas_notifications', 'rec_notifications', 'ret_notifications', 'tra_notifications', 'mea_notifications',
  'act_audit', 'sub_audit', 'cat_audit', 'pur_audit',
  'bas_audit', 'rec_audit', 'ret_audit', 'tra_audit', 'mea_audit',
  'supervisoryAuthority', 'legalFramework',
  'footer',
] as const;
...
const en: RopaLabels = {
  ...
  cat_masterProfile: 'Professional description, experience, city, category, WhatsApp, photos',
  ...
  bas_verification: 'Legea 133 Art. 5(1)(f) / GDPR Art. 6(1)(f) — Legitimate interest',
  ...
  bas_reviews: 'Legea 133 Art. 5(1)(f) / GDPR Art. 6(1)(f) — Legitimate interest',
  ...
  cat_loginHistory: 'IP address, user agent, timestamp, success/failure, location',
  pur_loginHistory: 'Security monitoring, fraud prevention',
  bas_loginHistory: 'Legea 133 Art. 5(1)(f) / GDPR Art. 6(1)(f) — Legitimate interest',
  ...
  bas_analytics: 'Legea 133 Art. 5(1)(f) / GDPR Art. 6(1)(f) — Legitimate interest',
  ...
  bas_notifications: 'Legea 133 Art. 5(1)(b) / GDPR Art. 6(1)(b) Contract / Legea 133 Art. 5(1)(a) / GDPR Art. 6(1)(a) Consent',
  ...
  footer: 'This Record of Processing Activities is maintained in accordance with Legea nr. 133/2011 (Republic of Moldova) and GDPR Article 30, and will be updated upon any material changes to processing operations. Supervisory authority: NCPDP.',
};
...
const ru: RopaLabels = {
  ...
  bas_verification: 'Закон 133 Ст. 5(1)(f) / GDPR Ст. 6(1)(f) — Законный интерес',
  rec_verification: 'Только администраторы',
  ret_verification: 'Удаляются после верификации + 30 дней',
  tra_verification: 'Нет',
  mea_verification: 'Шифрованное хранилище, доступ только для админов, автоудаление',
  ...
  bas_loginHistory: 'Закон 133 Ст. 5(1)(f) / GDPR Ст. 6(1)(f) — Законный интерес',
  ...
  bas_consent: 'Закон 133 Ст. 5(1)(c) / GDPR Ст. 6(1)(c) — Юридическое обязательство',
  ...
  bas_notifications: 'Закон 133 Ст. 5(1)(b) / GDPR Ст. 6(1)(b) Договор / Закон 133 Ст. 5(1)(a) / GDPR Ст. 6(1)(a) Согласие',
  ...
  footer: 'Настоящий реестр операций по обработке ведётся в соответствии с Законом nr. 133/2011 (Республика Молдова) и статьёй 30 GDPR, и будет обновлён при любых существенных изменениях. Надзорный орган: НЦЗПД.',
};
...
const ro: RopaLabels = {
  ...
  cat_masterProfile: 'Descriere, experiență, oraș, categorie, WhatsApp, fotografii',
  ...
  bas_verification: 'Legea 133 Art. 5(1)(f) / GDPR Art. 6(1)(f) — Interes legitim',
  ...
  bas_loginHistory: 'Legea 133 Art. 5(1)(f) / GDPR Art. 6(1)(f) — Interes legitim',
  ...
  bas_notifications: 'Legea 133 Art. 5(1)(b) / GDPR Art. 6(1)(b) Contract / Legea 133 Art. 5(1)(a) / GDPR Art. 6(1)(a) Consimțământ',
  ...
  footer: 'Acest Registru al activităților de prelucrare este menținut în conformitate cu Legea nr. 133/2011 (Republica Moldova) și Articolul 30 din GDPR, și va fi actualizat la orice modificare materială a operațiunilor de prelucrare. Autoritate de supraveghere: CNPDCP.',
};

export const ROPA_LABELS: Record<'en' | 'ru' | 'ro', RopaLabels> = { en, ru, ro };
